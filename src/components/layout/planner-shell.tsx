...
export function PlannerShell({ locations, edges, waypoints, chartPmtilesUrl }: PlannerShellProps) {
  const composition = useMemo(
    () => createComposition(locations, edges, waypoints),
    [locations, edges, waypoints]
  );
